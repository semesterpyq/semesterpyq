            ...
            <form onSubmit={handleEditSubmit} className="p-6 overflow-y-auto space-y-4 text-xs sm:text-sm">
              ...
              <div className="flex items-center justify-end space-x-3 pt-4 border-t border-slate-100">
                ...
                <button
                  type="submit"
                  disabled={editSaving}
                  className="px-6 py-2 bg-blue-600 hover:bg-blue-700 disabled:opacity-50 text-white rounded-xl font-bold cursor-pointer inline-flex items-center space-x-2"
                >
                  {editSaving ? (
                    <>
                      <Loader2 className="w-4 h-4 animate-spin" />
